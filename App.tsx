    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-amber-200 selection:text-amber-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-slate-900 hidden sm:block">
              Encontre o <span className="text-amber-500">Job</span>
            </h1>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="bg-amber-500 hover:bg-amber-600 text-white font-bold py-2 px-4 rounded-full transition-colors flex items-center gap-2 shadow-md hover:shadow-lg">
      ...
      <main className="pb-20">
        ...
        <div className="relative overflow-hidden bg-white border-b border-slate-200">
          ...
          <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-amber-200/40 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
              ...
              <select 
                ...
                className="bg-white border border-slate-300 text-slate-700 rounded-lg px-4 py-2 focus:border-amber-500 focus:outline-none shadow-sm"
              >
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full sm:w-64 bg-white border border-slate-300 text-slate-700 rounded-lg pl-9 pr-4 py-2 focus:border-amber-500 focus:outline-none shadow-sm"
                />
              </div>
            </div>
          </div>
          ...
          {filteredProviders.length > 0 ? (
            ...
            <div className="text-center py-20 border border-dashed border-slate-300 rounded-xl bg-white">
              ...
              <h3 className="text-xl font-medium text-slate-600">Nenhum profissional encontrado</h3>
      ...
      <footer className="bg-white border-t border-slate-200 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 text-slate-500 text-sm">
            <a href="#" className="hover:text-amber-600 transition-colors">Termos</a>
